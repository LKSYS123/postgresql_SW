    ...
    api: {
        ...
        login: (body, callback) => {
            UserInfo.findAll({
                where: {
                    [Op.and]: [
                        { UserId: body.UserId, UserPass: body.UserPass },
                    ],
                },
            })
                .then((data) => {
        ...
        deletePost: (body, callback) => {
            Post.destroy({
                ...
                .then(callback(true), console.log('=====포스트 삭제 성공====='))
                .catch((err) => {
        ...
        deleteData: (body, callback) => {
            Sports.destroy({
                ...
                .then(callback(true), console.log('=====데이터 삭제 성공====='))
                .catch((err) => {
